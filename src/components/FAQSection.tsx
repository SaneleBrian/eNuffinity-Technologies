...
import { ChevronRight, Shield, Clock, Code, FileText, Headphones, Globe, DollarSign, Layers } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-5xl">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-5 leading-tight" style={{ lineHeight: '1.1' }}>
            Questions we get
            <br />
            <span className="gradient-text">asked the most</span>
          </h2>
        ...
        {/* Two-column layout with staggered reveal */}
        <div ref={cards.ref} className="grid md:grid-cols-2 gap-4 mx-auto">
          {faqs.map((faq, index) => {
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className={`text-xs font-mono tracking-wider uppercase px-2.5 py-1 rounded-md transition-colors duration-300 ${
                      isOpen 
                  ...
                  <div className="flex items-start gap-3">
                    <ChevronRight className={`w-4 h-4 mt-1 shrink-0 transition-transform duration-300 ${
        ...
        >
          <div className="gradient-border rounded-2xl bg-card/80 p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm">We'd love to hear from you — no obligation, just a conversation.</p>
            </div>
            <a
              href="#contact"
